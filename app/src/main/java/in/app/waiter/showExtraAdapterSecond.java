...
public class showExtraAdapterSecond extends BaseAdapter {
    ...
    public showExtraAdapterSecond(Context context, ArrayList<Extra> myList, CartItems cartItems, ViewGroup parent, int groupPosition, ArrayList<CartItems> mGroups) {
        this.myList = myList;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        mViewHolder.plusebtn.setText("1");
           ...
           mViewHolder.minus.setOnClickListener(new View.OnClickListener() {
         	...
         	reload(mGroups.get(position).get_item().get_category().get_id());
