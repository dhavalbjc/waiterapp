...
public class TestCustomExpandableListAdapter extends BaseExpandableListAdapter {
  ...
  //  public static LinkedHashMap<String, Boolean> myCartHash = new LinkedHashMap<String, CartItems>();
    public TestCustomExpandableListAdapter(Context context, ArrayList<CartItems> groups,int dWidth, String conValue) {
        mContext = context;
        mGroups = groups;
				...
				//	 Toast.makeText(mContext,String.valueOf(b),Toast.LENGTH_LONG).show();
          		    ...
          		    //    Helper.getListViewSize(Item_selected.listView);
	                    ...
	                    //	 plusebtn.setText(String.valueOf(1));
	                       ...
	                       /*  for(int i=0; i < Item_selected.cartItemadapter1.getGroupCount(); i++)
	                      		Item_selected.listView.collapseGroup(i);*/
	                         //Item_selected.cartItemadapter1.notifyDataSetChanged();
	                         Item_selected.activityCallback.onButtonClick();
	                        // lbm.sendBroadcast(i);
				...
				catch(Exception e)
				{
					...
					// show mak dialog
					 ...
					 lin_cooking.setOnClickListener(new View.OnClickListener() {
						...
						public void onClick(View arg0) {
							// TODO Auto-generated method stub
							// Toast.makeText(mContext,group.get_status(),Toast.LENGTH_LONG).show();
							if(!group.get_status().equals("2")){
							if(group.get_mark()==0){
